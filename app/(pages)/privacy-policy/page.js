      ...
      >
        <div className="text-center mb-5 md:mb-10">
          <h1 className="mb-1 text-3xl md:text-5xl font-semibold">
            Privacy Policy for <span className="bl_un">Swippy</span> Tech LLP
          </h1>
        ...
        <div className="p-6 md:p-8 rounded-3xl bg-white/70 shadow-lg shadow-[#6840ff]/5 border border-gray-200/50 dark:bg-black/90 dark:border-gray-800/50">
          ...
          <h2 className="text-xl md:text-2xl font-medium mt-8 mb-4">Interpretation and Definitions</h2>
          ...
          <ul className="list-disc pl-6 mb-4">
            ...
            <li>
              <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Swippy Tech LLP, Dhangvi, Kotkhai Local Bazaar, Shimla, Himachal Pradesh, 171202.</p>
            </li>
            <li>
            ...
            <li>
              <p><strong>Website</strong> refers to Proppo, accessible from <a href="https://www.proppo.in" rel="external nofollow noopener" target="_blank" className="text-[#6840ff] hover:underline">https://www.proppo.in</a></p>
            </li>
            <li>
          ...
          <h2 className="text-xl md:text-2xl font-medium mt-8 mb-4">Collecting and Using Your Personal Data</h2>
          ...
          <h4 className="text-base font-medium mb-2">Information from Third-Party Social Media Services</h4>
          <p className="mb-4">
          ...
          <h4 className="text-base font-medium mb-2">Tracking Technologies and Cookies</h4>
          <p className="mb-4">
          ...
          <h3 className="text-lg font-medium mb-2">Retention of Your Personal Data</h3>
          <p className="mb-4">
          ...
          <h3 className="text-lg font-medium mb-2">Transfer of Your Personal Data</h3>
          <p className="mb-4">
          ...
          <h3 className="text-lg font-medium mb-2">Delete Your Personal Data</h3>
          <p className="mb-4">
          ...
          <h3 className="text-lg font-medium mb-2">Disclosure of Your Personal Data</h3>
          <h4 className="text-base font-medium mb-2">Business Transactions</h4>
          <p className="mb-4">
            If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.
          </p>
          <h4 className="text-base font-medium mb-2">Law enforcement</h4>
          <p className="mb-4">
            Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
          </p>
          <h4 className="text-base font-medium mb-2">Other legal requirements</h4>
          <p className="mb-4">
          ...
          <h2 className="text-xl md:text-2xl font-medium mt-8 mb-4">Children&apos;s Privacy</h2>
          <p className="mb-4">
          ...
          <h2 className="text-xl md:text-2xl font-medium mt-8 mb-4">Links to Other Websites</h2>
          <p className="mb-4">
          ...
          <h2 className="text-xl md:text-2xl font-medium mt-8 mb-4">Changes to this Privacy Policy</h2>
          <p className="mb-4">
          ...
          <ul className="list-disc pl-6 mb-4">
            <li>By email: <a href="mailto:mail@swippy.in" className="text-[#6840ff] hover:underline">mail@swippy.in</a></li>
          </ul>
        </div>
      </div>
      <GoBackButton/>
